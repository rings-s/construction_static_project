					...
					{#each socialLinks as social}
						...
						>
							...
							{:else if social.icon === 'twitter'}
								<Twitter class="w-5 h-5 group-hover:scale-110 transition-transform duration-300" />
							{:else if social.icon === 'instagram'}
								<Instagram class="w-5 h-5 group-hover:scale-110 transition-transform duration-300" />
							{/if}
						</a>
					{/each}
				</div>
			...
			<div class="space-y-6">
				...
				<div class="space-y-6">
					...
					<a 
						...
						target="_blank"
						rel="noopener noreferrer"
						class="group flex items-center justify-center w-full bg-emerald-600/20 hover:bg-emerald-600/30 border border-emerald-600/30 hover:border-emerald-600/50 p-4 rounded-xl transition-all duration-300 hover:scale-105"
					>
